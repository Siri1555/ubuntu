...
//Node Declaration
//o(h) worst and o(1) best tree
struct node    //o(n) bst and o(logn) for hight balance  space o(n)
{
...
void BST::create_tree()
{
 ...
 cin>>root->label;   //-> arrow is used to access class struct members using pointer
