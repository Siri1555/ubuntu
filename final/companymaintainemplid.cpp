...
class Employee
{
    ...
    public:
        ...
        {
            strcpy(this->name,name); //copy source string i destinaion str 
            strcpy(this->city,city);
            this->empid=empid;  //this key is implicit obj paramter when obj member fun is call and refernce t inovke obj
            this->salary=salary;
            this->role=role;
        }
        int getRollNo()
