#include <iostream>
using namespace std;
class Node //avl tree bst with balance fact and O(logn) n is node
{
public:
    Node *Left, *Right;
    string key, val;
...
5.Exit
Enter your Choice 1
Enter the Word and Meaning: Ponder
think
=====MENU=====
1.Add Word
2.Delete Word
...
5.Exit
Enter your Choice 1
Enter the Word and Meaning: Elated
happy
=====MENU=====
1.Add Word
2.Delete Word
...
5.Exit
Enter your Choice 1
Enter the Word and Meaning: Astronaut
Star_sailor
=====MENU=====
1.Add Word
2.Delete Word
...
5.Exit
Enter your Choice 3
Enter the Word you want to Update: Elated
Word Found!
Word: Elated happy
...
5.Exit
Enter your Choice 2
Enter the Word you want to Delete: Astronaut
Deleted
=====MENU=====
1.Add Word
2.Delete Word
